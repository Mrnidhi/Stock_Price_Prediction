...
def etl_pipeline():
    ...
    def fetch_stock_data(symbols):
        # Fetch stock data from Yahoo Finance for the last 180 days
        data_frames = []
    ...
    def load_to_snowflake(stock_data_df):
        # Load data into Snowflake with proper transaction handling
        ...
        cursor = conn.cursor()
        target_table = "USER_DB_MAGPIE.STOCK_PREDICTOR.stock_data"
        try:
